...
namespace Interface {
    ...
    public partial class PurchasesDataSet : global::System.Data.DataSet {
        ...
        public partial class PurchasesDataTable : global::System.Data.TypedTableBase<PurchasesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public PurchasesRow AddPurchasesRow(System.DateTime PurchaseDate, string Organization, string City, string Country, string Manager, int Quantity, decimal Amount) {
        ...
        public partial class PurchasesRow : global::System.Data.DataRow {
            ...
            public string Organization {
                get {
                    return ((string)(this[this.tablePurchases.OrganizationColumn]));
                }
                set {
                    this[this.tablePurchases.OrganizationColumn] = value;
                }
            }
            ...
            public string City {
                get {
                    return ((string)(this[this.tablePurchases.CityColumn]));
                }
                set {
                    this[this.tablePurchases.CityColumn] = value;
                }
            }
            ...
            public string Country {
                get {
                    return ((string)(this[this.tablePurchases.CountryColumn]));
                }
                set {
                    this[this.tablePurchases.CountryColumn] = value;
                }
            }
            ...
            public string Manager {
                get {
                    return ((string)(this[this.tablePurchases.ManagerColumn]));
                }
                set {
                    this[this.tablePurchases.ManagerColumn] = value;
                }
            }
...
namespace Interface.PurchasesDataSetTableAdapters {
    ...
    public partial class PurchasesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Purchases] WHERE (([Id] = @Original_Id) AND ([PurchaseDate] = " +
                "@Original_PurchaseDate) AND ([Quantity] = @Original_Quantity) AND ([Amount] = @O" +
                "riginal_Amount))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Purchases] ([PurchaseDate], [Organization], [City], [Country], [Manager], [Quantity], [Amount]) VALUES (@PurchaseDate, @Organization, @City, @Country, @Manager, @Quantity, @Amount);
SELECT Id, PurchaseDate, Organization, City, Country, Manager, Quantity, Amount FROM Purchases WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Purchases] SET [PurchaseDate] = @PurchaseDate, [Organization] = @Organization, [City] = @City, [Country] = @Country, [Manager] = @Manager, [Quantity] = @Quantity, [Amount] = @Amount WHERE (([Id] = @Original_Id) AND ([PurchaseDate] = @Original_PurchaseDate) AND ([Quantity] = @Original_Quantity) AND ([Amount] = @Original_Amount));
SELECT Id, PurchaseDate, Organization, City, Country, Manager, Quantity, Amount FROM Purchases WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Interface.Properties.Settings.Default.PurchasesConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, PurchaseDate, Organization, City, Country, Manager, Quantity, Amount F" +
                "ROM dbo.Purchases";
        ...
        public virtual int Fill(PurchasesDataSet.PurchasesDataTable dataTable) {
        ...
        public virtual PurchasesDataSet.PurchasesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PurchasesDataSet.PurchasesDataTable dataTable = new PurchasesDataSet.PurchasesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(PurchasesDataSet.PurchasesDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, System.DateTime Original_PurchaseDate, int Original_Quantity, decimal Original_Amount) {
        ...
        public virtual int Insert(System.DateTime PurchaseDate, string Organization, string City, string Country, string Manager, int Quantity, decimal Amount) {
        ...
        public virtual int Update(System.DateTime PurchaseDate, string Organization, string City, string Country, string Manager, int Quantity, decimal Amount, int Original_Id, System.DateTime Original_PurchaseDate, int Original_Quantity, decimal Original_Amount, int Id) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(System.DateTime PurchaseDate, string Organization, string City, string Country, string Manager, int Quantity, decimal Amount, int Original_Id, System.DateTime Original_PurchaseDate, int Original_Quantity, decimal Original_Amount) {
            return this.Update(PurchaseDate, Organization, City, Country, Manager, Quantity, Amount, Original_Id, Original_PurchaseDate, Original_Quantity, Original_Amount, Original_Id);
        }
    }
